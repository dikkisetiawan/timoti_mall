  ...
  Future<void> getOrderData(String userData) async {
    ...
    if (lastDocument == null) {
      ...
      orderSnapshot = await firestore
          ...
          .where("Financial_Status", isEqualTo: 'paid')
          .where("Order_Financial_Status", isEqualTo: 'paid')
          .where("Order_Fulfillment_Status", isEqualTo: 'fulfilled')
          .where("Order_Cancelled_Status", isEqualTo: false)
          .where("Refund_Status", isEqualTo: false)
          .where("Order_Cancelled_Request_Status", isEqualTo: false)
          .where("Order_Received_Status", isEqualTo: false)
