...
class CustomContainer extends StatelessWidget {
  ...
  // final SearchContentArgument searchContentArgument;
  // final DestinationDetailsArgument destinationDetailsArgument;
  final int position;
  ...
  const CustomContainer({
    ...
    // this.searchContentArgument,
    // this.destinationDetailsArgument,
    this.position = 0,
  }) : super(key: key);
    ...
    return Padding(
      ...
      child: SizedBox(
        ...
        child: Material(
          ...
          child: InkWell(
            onTap: () {
              // if(routeString == DestinationDetailPage.routeName){
              //   Navigator.pushNamed(context, routeString, arguments: destinationDetailsArgument);
              // }
              // else if(routeString == SearchContentPage.routeName){
              //   Navigator.pushNamed(context, routeString, arguments: searchContentArgument);
              // }
            },
