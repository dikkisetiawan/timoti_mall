...
class LinkPhoneStepTwo extends StatefulWidget {
  ...
  @override
  _LinkPhoneStepTwoState createState() => _LinkPhoneStepTwoState(
        phoneNumber,
        verificationId,
      );
}

class _LinkPhoneStepTwoState extends State<LinkPhoneStepTwo> {
  String phoneNumber = '';
  String verificationId = '';
  bool hasReturn = false;
  SignInType type = SignInType.Password;
  _LinkPhoneStepTwoState(
  ...
  void _signInWithPhoneNumber(
    ...
    try {
      ...
      firebaseUser.linkWithCredential(credential).then((user) {
        ...
        // authService.updateLinkPhoneStatus(firebaseUser, true);
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: Text(
                "Successfully Linked Phone Number",
                style: TextStyle(
